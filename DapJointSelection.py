    ...
    def execute(self, obj):
        ...
        if joint_index == 0 and obj.Point1RelMov != "":
            ...
            if llen > 1e-6 and obj.Point1RelMov != "":
                ...
                cylinder = Part.makeCylinder(0.05 * llen, 0.5 * llen, obj.CoordPoint1RelMov + 0.25 * llen * lin_move_dir, lin_move_dir)
                cone1 = Part.makeCone(0, 0.1 * llen, 0.25 * llen, obj.CoordPoint1RelMov, lin_move_dir)
                cone2 = Part.makeCone(0, 0.1 * llen, 0.25 * llen, obj.CoordPoint2RelMov, -lin_move_dir)
                ...
                if obj.Point1RelMov != "" and obj.Point2RelMov != "":
                    FreeCAD.Console.PrintError("The selected 2 points either coincide, or are too close together!!!")
        else:
            obj.Shape = Part.Shape()
